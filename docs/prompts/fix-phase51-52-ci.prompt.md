# Codex Prompt · Fix Phase 51/52 Validation + apps/zeaz-web Tailwind Oxide Build
...
3. apps/zeaz-web Next.js build fails because Tailwind oxide native optional dependency @tailwindcss/oxide-linux-x64-gnu is missing.
...
4. Update apps/zeaz-web CI build step to run scripts/ci/install-web-deps-safe.sh before npm run build.
...
7. Run make phase51-validate, make phase52-validate, and apps/zeaz-web build.
