...
**Read `.ai-factory/skill-context/zai-build-automation/SKILL.md`** — MANDATORY if the file exists.
...
```
Read skills/zai-build-automation/references/BEST-PRACTICES.md
```
...
```
Read skills/zai-build-automation/templates/<selected-template>
```
