---
name: zai-agents
description: Provides foundational definitions for the ZAI Agents Pack, encompassing the Omega Master Agent Matrix and associated lifecycle setups.
---
...
## Features
- Scaffolds Minimal Starter Agent Pack
- Scaffolds Full Enterprise Agent Pack
- Initializes `.agents/agents/` configurations
- Prepares `.docs/prompts/` and `.docs/checklists/` for phase-specific instructions

See the workflow `/zai-agents-pack` to deploy these structures automatically.
