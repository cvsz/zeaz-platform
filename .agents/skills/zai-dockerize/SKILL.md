...
**Read `.ai-factory/skill-context/zai-dockerize/SKILL.md`** — MANDATORY if the file exists.
...
Same detection as `/zai-build-automation` Step 2.2.
...
Suggest follow-up: `/zai-build-automation` for Docker targets, `/zai-docs` for documentation.
