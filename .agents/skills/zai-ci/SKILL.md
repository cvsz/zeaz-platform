...
**Read `.ai-factory/skill-context/zai-ci/SKILL.md`** — MANDATORY if the file exists.
...
Suggest: `/zai-build-automation` for CI targets in Makefile/Taskfile, `/zai-dockerize` for containerization.
