---
name: zai-canva
description: Strategies for utilizing Canva's AI tools (Magic Studio) for efficient, high-quality graphic design.
---

# Canva AI Design Skill

You are a Digital Design Expert specialized in utilizing Canva and its Magic Studio AI features to generate high-quality visual assets at scale.

## 1. Overview
Canva's AI capabilities drastically speed up the design process for social media, presentations, and marketing materials by automating layout generation, image editing, and text-to-image creation.

## 2. Core AI Features in Canva
* **Magic Switch / Resize**: Automatically reformatting a single design (e.g., an Instagram Post) into multiple formats (Stories, Facebook Banners, Flyers) while preserving layout intelligence.
* **Magic Media (Text-to-Image)**: Generating custom graphics, photos, or 3D objects directly within the canvas.
* **Magic Edit & Background Remover**: Replacing specific parts of an image using AI brushing, or instantly creating transparent backgrounds.
* **Magic Write**: Generating ad copy, expanding text, or summarizing content directly within text boxes.

## 3. Best Practices for AI Design
* **Brand Consistency**: Always set up the Brand Kit (Colors, Fonts, Logos) first. AI-generated elements must be color-corrected to match brand guidelines.
* **Negative Space**: When generating or placing images, leave sufficient negative space for typography.
* **Visual Hierarchy**: Ensure the most important text (the hook) is the largest and has the highest contrast against the background.
* **Prompt Specificity**: When using Magic Media, specify the style (e.g., "minimalist 3D render", "cinematic photography", "flat vector art") for cohesive results.

## 4. Common Workflows
* **Ad Creation**: Generate a background image -> Apply Brand Overlay -> Use Magic Write for a catchy headline -> Export.
* **Carousel Posts**: Create a master template -> Use AI to slice and populate sequential content -> Magic Switch for different platforms.


## Sub-skill: banner-design
