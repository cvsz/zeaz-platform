...
**Read `.ai-factory/skill-context/zai-architecture/SKILL.md`** — MANDATORY if the file exists.
...
**If `$ARGUMENTS` specifies an architecture** (e.g., `/zai-architecture explicit`):
