<?php 
//this php file lets you edit the selected operator
//powered by zcino
...
$row = mysqli_fetch_array(mysqli_query($GLOBALS['con'],"SELECT * FROM cws_staffs WHERE `id`='".antisqli($_POST['id'])."' AND `staff_type`='operator'"));
?>
...
$("#update").click(function() {
				...
				showparam('um_edit_o','update=1&'+'login='+login+'&'+'has_subagent='+has_subagent+'&'+'pass='+pass+'&'+'email='+email+'&'+'name='+name+'&'+'percent='+percent+'&'+'fam='+fam+'&'+'status='+status+'&cash='+cash+'&cash_paid='+cash_paid+'&'+'id='+'<?=antisqli($_POST['id'])?>');
							 });
</script>
</div>
</fieldset>
