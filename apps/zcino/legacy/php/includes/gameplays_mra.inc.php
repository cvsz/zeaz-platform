...
<div style="padding-top:20px;text-align:center"><h2>Multiplayer AM Roulette - <?php echo $lang['Gameplay+history']?></h2></div>
<div id="yourDetails" style="padding-top:30px;text-align:center">
			  <table width="760" height="25" cellspacing="5" class="cTable">
						<tr >
                            ...
                            <td width="54" style="color:#999">DRAWN NUMBER</td>
...
$query = "SELECT id,(SELECT number FROM cws_roulette_am_results WHERE id=x.drawid) AS number, drawid,'ROULETTE AM' as name,date,bet,sum_won FROM cws_roulette_am_bets x WHERE user='{$_SESSION['username']}' AND mode='real'";
...
while($row = mysqli_fetch_assoc($result)) {
	...
	echo "				  <tr $tdstyle>
						  ...
						  <td><strong>$row[drawid]</strong></td>
