...
<div style="padding-top:20px;text-align:center">
  <h2>Multiplayer Sic Bo- <?php echo $lang['Gameplay+history']?></h2></div>
<div id="yourDetails" style="padding-top:30px;text-align:center">
			  <table width="760" height="25" cellspacing="5" class="cTable">
						<tr >
                            ...
                            <td width="54" style="color:#999">DICES</td>
...
$query = "SELECT id,(SELECT dices FROM cws_sicbo_results WHERE id=x.drawid) AS number, drawid,'SICBO' as name,date,bet,sum_won FROM cws_sicbo_bets x WHERE user='{$_SESSION['username']}' AND mode='real'";
