...
<h3>Deposit {amount} {currency} via LINE Pay</h3>
<p style="color:#aaa;">Open your LINE app and scan this QR Code.</p>
<br />
<div style="background:#fff; padding: 20px; border-radius: 8px; display:inline-block; border:3px solid #06C755;">
    <!-- Mock QR Code -->
    <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg" alt="LINE Pay QR" width="200" height="200" />
</div>
<br /><br />
<div id="payment-status" style="color:yellow; font-weight:bold;">Waiting for LINE Pay confirmation...</div>
<br />
...
setTimeout(function() {
    $("#payment-status").css("color", "#00e701").text("LINE Pay Payment Received! Crediting account...");
