...
namespace newweb.QA_NEW
{
  public class Standard1 : Page
  {
    ...
    {
      new CConnect().sqlCmd("INSERT INTO [QA_project ] ([Project] ,Stdid,Year,[Active],[Createdate]) VALUES(@Project,'1',@Year,'1',@Createdate)", "@Project", this.txtNName.Value, "@Year", DateTime.Now.ToString("yyyy"), "@Createdate", DateTime.Now);
    }
