  ...
  public class Questionanswer : Page
  {
    ...
    private void addUser(string user)
    {
      ...
      if (this.CheckBox1.Checked)
        str2 = "1";
      string sql = "INSERT INTO [Question_data] ([Question_detail_id],[Question_data],[Iscorrect],[Active],[Detail_answer]) VALUES(@QuestionDetailId,@QuestionData,@IsCorrect,'1',@DetailAnswer)";
      cconnect.sqlCmd(sql, "@QuestionDetailId", str1, "@QuestionData", user, "@IsCorrect", str2, "@DetailAnswer", this.detailanswer.Value);
    }
