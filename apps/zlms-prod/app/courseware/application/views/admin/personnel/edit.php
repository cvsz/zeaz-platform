...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
     ...
     <div class="col-md-10">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="" name="fname" value="<?php echo $personnel->fname_personnel ; ?>">
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="" name="lname" value="<?php echo $personnel->lname_personnel ; ?>">
          </div>
      ...
      <div class="form-group">
        ...
        <select class="form-control chosen" name="faculty"  id="faculty">
        ...
        <script type="text/javascript">
         ...
         // $('#faculty').val('<?php echo $personnel->faculty_personnel; ?>');
         $('#faculty').val('<?php echo $personnel->faculty_personnel; ?>');
         $('#faculty').trigger("chosen:updated");
          //alert('<?php echo $personnel->faculty_personnel; ?>');
        });
      </script>
    ...
    <div class="form-group">
      ...
      <input class="form-control" id="" name="tel" value="<?php echo $personnel->tel_personnel ; ?>">
    </div>
    <div class="form-group">
      <label>อีเมล</label><span style="color: red;">&nbsp;</span><?php echo form_error('email'); ?>
      <input class="form-control" id="" name="email" value="<?php echo $personnel->mail_personnel ; ?>">
    </div>

    <input type="hidden" required="" readonly="" name="id" value="<?php echo $personnel->id_personnel ; ?>" >
