...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="panel panel-default">
    ...
    <?php echo form_open_multipart('admin/setting/insert_footer_type1'); ?> 
    <div class="panel-body">
     ...
     <div class="col-md-10">
      ...
      <div class="form-group">
        ...
        <input class="form-control" id="post_name" name="url" value="<?php echo set_value('url'); ?>">
      </div>

      <div class="form-group">
        <label>หน่วยงาน</label><span style="color: red;">&nbsp;*</span><?php echo form_error('type'); ?>
        <?php
        $options = array(
          ''  => '-เลือก-',
        ...
        echo form_dropdown('type', $options,'',  $js);
        ?>
      </div>
