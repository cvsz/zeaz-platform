  ...
  public class resultupload : Page
  {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      foreach (string fileKey in (NameObjectCollectionBase) this.Request.Files)
      {
        ...
        SafeUploadResult upload = FileUploadSecurity.Save(postedFile, "~/Results/", ownerId, string.Empty);
    ...
    private void addUser(string filename, string filepath, string ownerId)
    {
      ...
      cconnect.sqlCmdText("INSERT INTO QA_result_file ([resultID],[FileName],[FilePath],[userid],[CreatedDate],[Updatedate],[Updateby],Active) VALUES(@OwnerId,@FileName,@FilePath,@UserId,@CreatedDate,@Updatedate,@Updateby,@Active)");
      ...
      try
      {
        ...
        if (sqlDataReader.HasRows)
        {
          while (sqlDataReader.Read())
          {
            ...
            string href = "/Results/" + HttpUtility.UrlPathEncode(str1) + "/" + HttpUtility.UrlPathEncode(fileName);
