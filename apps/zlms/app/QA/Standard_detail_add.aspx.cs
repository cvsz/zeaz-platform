...
namespace newweb.QA
{
  public class Standard_detail_add : Page
  {
    ...
    private void addUser(string user)
    {
      ...
      string sql = "INSERT INTO [QA_standard_detail_add] ([Standardid] ,[Standard_detail] ,[Active],[Createdate],[Weight]) VALUES(@StandardId,@StandardDetail,'1',@Createdate,@Weight)";
      cconnect.sqlCmd(sql, "@StandardId", this.txtNName.Value, "@StandardDetail", str, "@Createdate", DateTime.Now, "@Weight", this.Text1.Value);
    }
