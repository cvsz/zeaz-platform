...
namespace newweb.Question
{
  public class Questiondetail : Page
  {
    ...
    private void addGroup(string user)
    {
      ...
      string sql = "INSERT INTO [Questiongroup] ([Questionid],[QuestiongroupName],[Active],[Createdate],[Createby]) VALUES(@QuestionId,@QuestionGroupName,'1',@Createdate,'1')";
      cconnect.sqlCmd(sql, "@QuestionId", id, "@QuestionGroupName", user, "@Createdate", DateTime.Now);
      this.SqlDataSource1.DataBind();
      try
      {
        this.GridView1.DataBind();
    ...
    private void addUser(string user)
    {
      ...
      string sql = "INSERT INTO [Question_detail] ([Question_id],[Question_detail],[Question_type],[Question_group],[Question_diff],[Question_weight]) VALUES(@QuestionId,@QuestionDetail,@QuestionType,@QuestionGroup,@QuestionDiff,@QuestionWeight)";
      cconnect.sqlCmd(sql, "@QuestionId", str4, "@QuestionDetail", user, "@QuestionType", str2, "@QuestionGroup", str1, "@QuestionDiff", this.DropDownList1.Text, "@QuestionWeight", this.DropDownList3.Text);
    }
