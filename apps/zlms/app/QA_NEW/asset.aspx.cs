...
namespace newweb.QA_NEW
{
  public class asset : Page
  {
    ...
    private void addUser1()
    {
      ...
      string sql = "delete QA_result where Projectid=@ProjectId";
    ...
    private void addUser(string filename, string filepath)
    {
      ...
      string sql = "INSERT INTO QA_result ([Projectid],[standard_detail_id],[Score],[Createdate]) VALUES(@ProjectId,@StandardDetailId,@Score,@Createdate)";
