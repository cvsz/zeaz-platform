...
namespace newweb.QA_NEW
{
  public class Standard : Page
  {
    ...
    private void addUser(string user)
    {
      ...
      string sql = "INSERT INTO [QA_standard] ([qaindicator],[qa_standard],[Active],[Createdate]) VALUES(@IndicatorId,@Standard,'1',@Createdate)";
      cconnect.sqlCmd(sql, "@IndicatorId", str, "@Standard", this.txtNName.Value, "@Createdate", DateTime.Now);
    }
