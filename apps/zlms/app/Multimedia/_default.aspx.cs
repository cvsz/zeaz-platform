...
namespace newweb.Multimedia
{
  public class _default : Page
  {
    ...
    {
      new CConnect().sqlCmd("INSERT INTO [Video] ([Viedeoname],[Videolink],[Active],[Createdate],[Createby]) VALUES(@VideoName,@VideoLink,'1',@Createdate,'1')", "@VideoName", this.txtNName.Value, "@VideoLink", this.txtlink.Value, "@Createdate", DateTime.Now);
    }
