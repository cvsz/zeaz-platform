...
`apps/zlms` is the legacy LMS production stack inside `cvsz/zeaz-platform`. It contains ASP.NET Web Forms legacy assets plus migration, security, and modernization documentation for Ubuntu/server deployment planning.
...
This README documents only `apps/zlms`. Do not mix zOffice, zDash, zWallet, or zTrader commands into this legacy LMS stack.
