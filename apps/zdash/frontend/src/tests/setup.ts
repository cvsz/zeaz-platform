...
const mocks = vi.hoisted(() => {
  ...
  const mockBranding: BrandingSettings = { organization_id: "org-1", workspace_id: "ws-1", brand_name: "zDash", logo_url: null, primary_color: "#7c3aed", accent_color: "#22c55e", support_email: "support@zeaz.dev", custom_domain: "zdash.zeaz.dev" };
