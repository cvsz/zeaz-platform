...
- **Multi-Image Upload Studio** — Upload up to 5 pet photos, write custom prompts, and see results instantly.
...
- **Personal Showroom Gallery** — All generated portraits are saved to PostgreSQL. Users can review, download, and delete their designs from `/gallery`.
...
│   └── schema.prisma           # Postgres schema (User, Account, Session, PetPortraitCreation)
├── src/
│   ├── app/                    # Next.js App Router
│   │   ├── page.js             # Main Pet Portrait Studio Workspace
...
_AI Pet Portrait Generator: A premium, high-contrast, fully responsive pet portrait studio built with the Inter font family._
